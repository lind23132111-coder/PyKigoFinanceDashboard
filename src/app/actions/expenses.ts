...
export async function getExpenses(filters?: {
    ...
    if (process.env.NEXT_PUBLIC_DEMO_MODE === 'true') {
        const isEn = lang === 'en';
        const mockExpenses = [
            // Reviewed (Current Month - September 2026)
            { id: '1', date: '2026-09-05', amount: 1250, store_name: isEn ? 'Breeze Supermarket' : '微風超市', project_label: 'general', goal_id: null, paid_by: 'PY', paid_for: 'Both', is_reviewed: true, is_automated: true, category_id: 'cat1', categories: { name: isEn ? 'Food & Dining' : '餐飲食品', icon: 'utensils', color: '#ef4444' } },
            { id: '2', date: '2026-09-08', amount: 4500, store_name: isEn ? 'IKEA' : '宜家家居', project_label: 'general', goal_id: 'demo-goal-1', paid_by: 'Kigo', paid_for: 'Both', is_reviewed: true, is_automated: false, category_id: 'cat2', categories: { name: isEn ? 'Home & Living' : '居家生活', icon: 'home', color: '#3b82f6' } },
            { id: '3', date: '2026-09-12', amount: 320, store_name: '7-Eleven', project_label: 'general', goal_id: null, paid_by: 'PY', paid_for: 'PY', is_reviewed: true, is_automated: true, category_id: 'cat1', categories: { name: isEn ? 'Food & Dining' : '餐飲食品', icon: 'utensils', color: '#ef4444' } },
            { id: '4', date: '2026-09-15', amount: 12000, store_name: isEn ? 'Elisa Electronics' : '全國電子', project_label: 'general', goal_id: null, paid_by: 'PY', paid_for: 'Kigo', is_reviewed: true, is_automated: false, category_id: 'cat3', categories: { name: isEn ? 'Electronics' : '電子產品', icon: 'cpu', color: '#8b5cf6' } },
            { id: '10', date: '2026-09-16', amount: 850, store_name: isEn ? 'Starbucks (Confirmed)' : '星巴克 (已確認)', project_label: 'general', goal_id: null, paid_by: 'PY', paid_for: 'Both', is_reviewed: true, is_automated: true, category_id: 'cat1', categories: { name: isEn ? 'Food & Dining' : '餐飲食品', icon: 'utensils', color: '#ef4444' } },

            // Unreviewed (AI Inbox / Smart Input)
            { id: '5', date: '2026-09-16', amount: 500, store_name: 'Starbucks', project_label: 'general', goal_id: null, paid_by: 'Kigo', paid_for: 'Both', is_reviewed: false, is_automated: true, category_id: 'cat1', categories: { name: isEn ? 'Food & Dining' : '餐飲食品', icon: 'utensils', color: '#ef4444' } },
            { id: '8', date: '2026-09-16', amount: 1580, store_name: 'Watsons', project_label: 'general', goal_id: null, paid_by: 'PY', paid_for: 'Both', is_reviewed: false, is_automated: true, category_id: 'cat4', categories: { name: isEn ? 'Personal Care' : '個人護理', icon: 'heart', color: '#ec4899' } },
            { id: '9', date: '2026-09-17', amount: 890, store_name: 'Uber Eats', project_label: 'general', goal_id: null, paid_by: 'PY', paid_for: 'Both', is_reviewed: false, is_automated: true, is_duplicate: true, category_id: 'cat1', categories: { name: isEn ? 'Food & Dining' : '餐飲食品', icon: 'utensils', color: '#ef4444' } },

            // Past Month (August 2026) - Home Renovation Goal
            { id: '6', date: '2026-08-15', amount: 8500, store_name: isEn ? 'B&Q Home' : '特力屋', project_label: 'general', goal_id: 'demo-goal-1', paid_by: 'PY', paid_for: 'Both', is_reviewed: true, is_automated: false, category_id: 'cat2', categories: { name: isEn ? 'Home & Living' : '居家生活', icon: 'home', color: '#3b82f6' } },
            { id: '7', date: '2026-08-20', amount: 1500, store_name: 'MUJI', project_label: 'general', goal_id: 'demo-goal-1', paid_by: 'Kigo', paid_for: 'PY', is_reviewed: true, is_automated: true, category_id: 'cat1', categories: { name: isEn ? 'Food & Dining' : '餐飲食品', icon: 'utensils', color: '#ef4444' } },

            // Past Month (July 2026)
            { id: 'jan1', date: '2026-07-10', amount: 3500, store_name: isEn ? 'Sushiro' : '壽司郎', project_label: 'general', goal_id: null, paid_by: 'PY', paid_for: 'Both', is_reviewed: true, is_automated: false, category_id: 'cat1', categories: { name: isEn ? 'Food & Dining' : '餐飲食品', icon: 'utensils', color: '#ef4444' } },
            { id: 'jan2', date: '2026-07-25', amount: 48000, store_name: isEn ? 'EVA Airways' : '長榮航空', project_label: 'general', goal_id: null, paid_by: 'Kigo', paid_for: 'Both', is_reviewed: true, is_automated: false, category_id: 'cat5', categories: { name: isEn ? 'Travel & Transport' : '交通旅遊', icon: 'plane', color: '#10b981' } }
        ];
...
export async function getCategories(lang?: string) {
    if (process.env.NEXT_PUBLIC_DEMO_MODE === 'true') {
        const isEn = lang === 'en';
        return [
            { id: 'cat1', name: isEn ? 'Food & Dining' : '餐飲食品', icon: 'utensils', color: '#ef4444' },
            { id: 'cat2', name: isEn ? 'Home & Living' : '居家生活', icon: 'home', color: '#3b82f6' },
            { id: 'cat3', name: isEn ? 'Electronics' : '電子產品', icon: 'cpu', color: '#8b5cf6' },
            { id: 'cat4', name: isEn ? 'Transportation' : '交通運輸', icon: 'car', color: '#10b981' }
        ] as ExpenseCategory[];
    }
 ...
 */
export async function getSplitSettlement(project_label?: string, goal_id?: string, startDate?: string, endDate?: string, lang?: string) {
    if (process.env.NEXT_PUBLIC_DEMO_MODE === 'true') {
        const isEn = lang === 'en';
        const mockExpenses = [
            { id: '1', date: '2026-03-05', amount: 1250, store_name: '微風超市', project_label: '一般帳務', paid_by: 'PY', paid_for: 'Both', is_reviewed: true },
            { id: '2', date: '2026-03-06', amount: 4500, store_name: '宜家家居', project_label: '新家裝修', paid_by: 'Kigo', paid_for: 'Both', is_reviewed: true },
            { id: '3', date: '2026-03-08', amount: 320, store_name: '7-11', project_label: '一般帳務', paid_by: 'PY', paid_for: 'PY', is_reviewed: true },
            { id: '4', date: '2026-03-09', amount: 12000, store_name: '全國電子', project_label: '一般帳務', paid_by: 'PY', paid_for: 'Kigo', is_reviewed: true },
            { id: '5', date: '2026-03-10', amount: 500, store_name: '星巴克', project_label: '一般帳務', paid_by: 'Kigo', paid_for: 'Both', is_reviewed: true },
            { id: '6', date: '2026-02-15', amount: 8500, store_name: '特力屋', project_label: '新家裝修', paid_by: 'PY', paid_for: 'Both', is_reviewed: true },
            { id: '7', date: '2026-02-20', amount: 1500, store_name: '無印良品', project_label: '新家裝修', paid_by: 'Kigo', paid_for: 'PY', is_reviewed: true }
        ];
        ...
        const summaryText = isEn
            ? (currentBalance > 0 ? "Kigo owes PY" : currentBalance < 0 ? "PY owes Kigo" : "Balanced (No Debt)")
            : (currentBalance > 0 ? "Kigo 應給付 PY" : currentBalance < 0 ? "PY 應給付 Kigo" : "雙方互不相欠");
        ...
        return {
            ...
            settled_total: 0,
            summary: summaryText,
            balance_status: isEn ? (currentBalance === 0 ? "Settled" : "Pending") : (currentBalance === 0 ? "已結清" : "待結算"),
    ...
    if (isDemo) {
        ...
        return {
            currentMonth: {
                ...
                endDate,
                categories: [
                    { name: isEn ? 'Food & Dining' : '餐飲食品', amount: 6500, color: '#ef4444' },
                    { name: isEn ? 'Home & Living' : '居家生活', amount: 4500, color: '#3b82f6' },
                    { name: isEn ? 'Electronics' : '電子產品', amount: 12000, color: '#8b5cf6' },
                    { name: isEn ? 'Other' : '其他', amount: 1264, color: '#94a3b8' }
                ]
            },
